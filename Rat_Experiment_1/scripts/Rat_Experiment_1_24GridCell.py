...
class RootWidget(GridLayout):
    ...
    def save_model(self):
        self.cnn.model.save_weights('rat_weights_24_Grid.h5',overwrite=True)
    ...
    def start_test(self, *args):
      ...
      self.data_file=open('Grid_Activations_24G_Room_2_Actual','w')
      if(self.check_1.active):
        self.load_model('rat_weights_24_Grid.h5')
      # Remove the button.
